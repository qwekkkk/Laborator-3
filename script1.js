...
{ document.getElementById("latitude").innerHTML = "Latitude =" + position.coords.latitude;
 document.getElementById("longitude").innerHTML="Longitude= " + position.coords.longitude;
  ...
  werelatlon=position.coords.latitude+","+ position.coords.longitude;
  wereimg_url= "https://maps.googleapis.com/maps/api/staticmap?center="+latlon+ "&zoom=14&size=400x300&key=AIzaSyAGLZIM3H0gKg4ktRobknb89yxWVFQCN4s";
